...
\begin{minipage}[t]{0.36\textwidth}
	...
	% 	{\huge\textbf IT engineer} 

	{\huge\textbf Software engineer} % Career or current job title
\end{minipage}
...
\begin{minipage}[t]{0.35\textwidth}
	...
	\icon{At}{12}{\href{mailto:mansourmahboubi@outlook.com}{mansourmahboubi@protonmail}}\\
