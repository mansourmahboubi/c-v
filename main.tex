...
% 		-- Responsible for IT infrastructure  \\ 
% 		-- Negotiating with other businesses to design and develop a way for communication between our systems (API) \\
% 		-- Work directly with marketing section to automate their work through simplest IT solution \\
% 		-- Managing IT resourses \\
...
% 	\entry
% 		{1/2019 -- 6/2019}
% 		{Teacher Assistant - Introduction to database}
% 		{ Faculty of engineering}
% 		{assistant for database course in fall 2019 \\ \texttt{database}\slashsep}
% \end{entrylist}
...
% 		{\href{https://virakad.com/}{Virakad.com}}
% 		{Cofounder, virakad.com was supposed to be a grocery marketplace .\\
% 		I was fullstack python developer and responsible for IT infra.\\
% 		find more at {\href{https://virakad.com/}{https://virakad.com/}}\\
% 		\texttt{linux}\slashsep\texttt{django}\slashsep\texttt{bootstrap}\slashsep\texttt{mysql}\slashsep\texttt{Cpanel}}
% \end{entrylist}
...
% 		{2017 -- 1/2018}
% 		{Wordpress developer}
% 		{\href{https://farsireviews.com/about}{Farsireviews.com}}
% 		{Cofounder, farsireview was a persian magazine and review producer .\\
% 		 I was responsible for It Infrastructure.\\
% 		find more at {\href{https://farsireviews.com/about}{https://farsireviews.com/about}}.\\
% 		\texttt{wordpress}\slashsep\texttt{php}\slashsep\texttt{bootstrap}\slashsep\texttt{Cpanel}}
% \end{entrylist}
% \begin{entrylist}
% 	\entry
% 		{2015 -- 2017}
% 		{member of IT association}
% 		{ faculty of engineering}
% 		{\\\\\\\\}
% \end{entrylist}
