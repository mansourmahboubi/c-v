...
\begin{entrylist}
    ...
    {
        Promoted to CTO to own the technical vision and engineering organization of the neobank. \\

        -- Define and drive the technical strategy and product roadmap in partnership with the CEO and board \\
        -- Lead the engineering organization: hiring, mentoring, and establishing engineering best practices \\
        -- Own the payment platform architecture (SEPA, VISA), security posture, and PCI compliance \\
        -- Align technology investments with business objectives, balancing delivery speed with reliability and cost \\
        ...
        \href{https://www.linkedin.com/company/welcome-place/}{Welcome Place - Paris, France / On-site}}
    {
        ...
        -- Directly reported to CTO, providing technical insights and strategic recommendations for product roadmap \\
